...
export const unauthorized = (data?: unknown): Response =>
  json(data ?? { error: "Unauthorized", code: "UNAUTHORIZED" }, 401);
export const forbidden = (data?: unknown): Response =>
  json(data ?? { error: "Forbidden", code: "FORBIDDEN" }, 403);
export const notFound = (data?: unknown): Response =>
  json(data ?? { error: "Not Found", code: "NOT_FOUND" }, 404);
...
export const serverError = (): Response =>
  json({ error: "Internal Server Error", code: "INTERNAL_ERROR" }, 500);
